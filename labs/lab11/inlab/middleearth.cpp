...
/*!
 * @brief create the world map
 *
 * This function establishes cities and sets their positions
 *
 * @return no return value
 * @param xisze the xsize of the world
 * @param ysize the ysize of the world
 * @param num_cities the number of cities created
 * @param seed ramdom number generator
 */
