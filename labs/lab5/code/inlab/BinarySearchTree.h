// Hanzhang Zhao hz9xs BinarySearchTree.h 10.4
#ifndef BST_H
#define BST_H
...
private:
    ...
    // private helper for find method
    bool find(const string& x, BinaryNode* current)const;
    // private helper for insert method
    void insert(BinaryNode*& current, const string& x);
    // Any other methods you need...
    // helper method for pathTo
    void pathTo(const string& x, BinaryNode* current, vector<string>& arr);
    //helper method for numNodes
    int numNodes(BinaryNode* current)const;
